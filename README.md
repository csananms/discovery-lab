...
**Love starts with a better question.**

Discovery Lab - Laboratory 0000: This is where the laboratory began.

## Contents

- [Lab Manifesto](./LAB_MANIFESTO.md)
...
- [Discovery D-0004](./discoveries/D-0004.md)
...
| Folder | Purpose |
| --- | --- |
| `notebook` | Daily research log |
| `ideas` | Unfinished thoughts |
| `experiments` | Testable hypotheses |
| `prototypes` | Working implementations |
| `decisions` | Why choices were made |
| `discoveries` | Durable pieces of knowledge |
| `references` | Papers and inspiration |
